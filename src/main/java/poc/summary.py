...
data   = pd.read_csv('/home/opc/IdeaProjects/tsbenchmysql-poc-meli/log/read_thread.csv', sep = ',', header=None)
...
data   = pd.read_csv('/home/opc/IdeaProjects/tsbenchmysql-poc-meli/log/write_thread.csv', sep = ',', header=None)
data.columns = ["ts", "query", "rowcount", "ela"]
